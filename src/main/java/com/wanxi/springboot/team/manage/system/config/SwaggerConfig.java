...
public class SwaggerConfig {
    ...
    public Docket createRestApi(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.wanxi.springboot.team.manage.system.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("SwaggerUI演示")
                .description("Team Manage System")
                .contact(new Contact("Jeffery","yxc745120.cn","2065719937@qq.com"))
                .version("1.0")
                .build();
    }
